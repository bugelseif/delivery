...
<body>
    <div class="container">
        <form action="{{route("tipoproduto.update", $tipoproduto->id)}}" method="POST">
            ...
            <div class="form-group">
                <label for="id-input-nome" class="form-label">descricao</label>
                <input name="descricao" type="text" class="form-control" id="id-input-descricao" placeholder="Digite o descricao" value="{{$tipoproduto->descricao}}" required>
            </div>
            <div class="my-1">
